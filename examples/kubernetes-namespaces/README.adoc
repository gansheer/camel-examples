== Camel Kubernetes route on Kubernetes cluster

This quickstart run in a Java standalone container, using Standalone Apache Camel (Kuberneted component).

This example is based on:

* Minikube ??? (Kubernetes version >= 1.17)
...
[source,sh]
----
$ minikube start --keep-context --memory=5120 --cpus=4
----
